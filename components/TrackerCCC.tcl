# Exporting core TrackerCCC to TCL
# Exporting Create design command for core TrackerCCC
create_and_configure_core -core_vlnv {Actel:SgCore:PF_CCC:2.2.100} -component_name {TrackerCCC} -params {\
...
# Exporting core TrackerCCC to TCL done
