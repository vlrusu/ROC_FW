...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {rocfifo_cntrl_0:rocfifo_wrcnt} -pin_slices {[11:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {rocfifo_cntrl_0:rocfifo_wrcnt} -pin_slices {[16:12]}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {rocfifo_cntrl_0:rocfifo_wrcnt[16:12]} -value {GND}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"SIM_ROC_FIFO_0:EMPTY" "rocfifo_cntrl_0:rocfifo_empty" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SIM_ROC_FIFO_0:FULL" "rocfifo_cntrl_0:rocfifo_full" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"SIM_ROC_FIFO_0:RE" "rocfifo_cntrl_0:rocfifo_re" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"SIM_ROC_FIFO_0:Q" "rocfifo_cntrl_0:rocfifo_data" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SIM_ROC_FIFO_0:WRCNT" "rocfifo_cntrl_0:rocfifo_wrcnt[11:0]" }
