...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {SLOWCONTROLS_0:DDRFIFODIA} -pin_slices {[0]}
...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {SLOWCONTROLS_0:DDRFIFODIA} -pin_slices {[1]}
...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {SLOWCONTROLS_0:DDRFIFODIA} -pin_slices {[4]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {SLOWCONTROLS_0:DDRFIFODIA} -pin_slices {[5]}
...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {SLOWCONTROLS_0:DDRFIFODIA} -pin_slices {[8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {SLOWCONTROLS_0:DDRFIFODIA} -pin_slices {[9]}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDRInterface_0:error_empty" "SLOWCONTROLS_0:DDRFIFODIA[8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDRInterface_0:error_full" "SLOWCONTROLS_0:DDRFIFODIA[9]" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDRInterface_0:read_empty" "SLOWCONTROLS_0:DDRFIFODIA[4]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDRInterface_0:read_full" "SLOWCONTROLS_0:DDRFIFODIA[5]" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDRInterface_0:write_empty" "SLOWCONTROLS_0:DDRFIFODIA[0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDRInterface_0:write_full" "SLOWCONTROLS_0:DDRFIFODIA[1]" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"SLOWCONTROLS_0:DTCSIMPARAM[24]" "DTCInterface_0:MARKER_SEL" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SLOWCONTROLS_0:DTCSIMPARAM[28]" "TOP_SERDES_0:DTCSIM_EN" }
