...
sd_create_scalar_port -sd_name ${sd_name} -port_name {RESET_CLK} -port_direction {IN}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {XCVR_Reset_Controller_0_0:ALGO_CLK} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {XCVR_Reset_Controller_0_0:ALGO_RESET} -value {VCC}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE0_TX_CLK_R" "Core_PCS_0:EPCS_TxCLK" "XCVR_IF_0:LANE0_TX_CLK_R" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"XCVR_Reset_Controller_0_0:RX_RESET_N" "Core_PCS_0:EPCS_RxRSTn" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"XCVR_Reset_Controller_0_0:TX_RESET_N" "Core_PCS_0:EPCS_TxRSTn" }
