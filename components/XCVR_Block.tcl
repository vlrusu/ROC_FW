...
# Add CORERESET_SYNC_RXCLK_0 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {CORERESET_PF_C0} -instance_name {CORERESET_SYNC_RXCLK_0}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_SYNC_RXCLK_0:BANK_x_VDDI_STATUS} -value {VCC}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_SYNC_RXCLK_0:BANK_y_VDDI_STATUS} -value {VCC}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_SYNC_RXCLK_0:SS_BUSY} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_SYNC_RXCLK_0:FF_US_RESTORE} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_SYNC_RXCLK_0:FPGA_POR_N} -value {VCC}



# Add CORERESET_SYNC_TXCLK_0 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {CORERESET_PF_C0} -instance_name {CORERESET_SYNC_TXCLK_0}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_SYNC_TXCLK_0:BANK_x_VDDI_STATUS} -value {VCC}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_SYNC_TXCLK_0:BANK_y_VDDI_STATUS} -value {VCC}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_SYNC_TXCLK_0:SS_BUSY} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_SYNC_TXCLK_0:FF_US_RESTORE} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_SYNC_TXCLK_0:FPGA_POR_N} -value {VCC}
...
# Add MX2_5 instance
sd_instantiate_macro -sd_name ${sd_name} -macro_name {MX2} -instance_name {MX2_5}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MX2_5:B} -value {VCC}



# Add MX2_6 instance
sd_instantiate_macro -sd_name ${sd_name} -macro_name {MX2} -instance_name {MX2_6}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MX2_6:B} -value {VCC}
...
sd_instantiate_component -sd_name ${sd_name} -component_name {CORERESET_PF_C0} -instance_name {XCVR_Controller_Init}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"MX2_4:B" "CORERESET_SYNC_RXCLK_0:FABRIC_RESET_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MX2_3:B" "CORERESET_SYNC_TXCLK_0:FABRIC_RESET_N" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"XCVR_Controller_Init:EXT_RST_N" "CORERESET_SYNC_RXCLK_0:EXT_RST_N" "EXT_RST_N" "CORERESET_SYNC_TXCLK_0:EXT_RST_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"XCVR_Controller_Init:INIT_DONE" "CORERESET_SYNC_RXCLK_0:INIT_DONE" "INIT_DONE" "CORERESET_SYNC_TXCLK_0:INIT_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE0_RX_CLK_R" "XCVR_IF_0:LANE0_RX_CLK_R" "Core_PCS_0:EPCS_RxCLK" "CORERESET_SYNC_RXCLK_0:CLK" "mux_rxout_0:RX_CLK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE0_TX_CLK_R" "XCVR_IF_0:LANE0_TX_CLK_R" "ReplyPktDecoder_0:TX_CLK" "Core_PCS_0:EPCS_TxCLK" "CORERESET_SYNC_TXCLK_0:CLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"XCVR_Reset_Controller_0_0:TX_CLK_STABLE" "MX2_5:Y" "LANE0_TX_CLK_STABLE" "CORERESET_SYNC_TXCLK_0:PLL_LOCK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"XCVR_Reset_Controller_0_0:RX_READY" "Core_PCS_0:EPCS_READY" "CORERESET_SYNC_RXCLK_0:PLL_LOCK" "MX2_6:Y" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Core_PCS_0:EPCS_RxRSTn" "MX2_4:Y" "mux_rxout_0:RX_RSTN" "RX_RESETN" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SIM_EN" "MX2_3:S" "MX2_2:S" "MX2_4:S" "MX2_5:S" "MX2_6:S" "mux_rxout_0:SIM_EN" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"XCVR_IF_0:LANE0_RX_READY" "MX2_6:A" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"XCVR_IF_0:LANE0_TX_CLK_STABLE" "MX2_5:A" }
