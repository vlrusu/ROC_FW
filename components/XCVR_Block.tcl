...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {Core_PCS_0:TX_DATA} -value {0011110010111100}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {Core_PCS_0:TX_K_CHAR} -value {11}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALIGNED" "ClockAligner_0:PCS_ALIGNED" "Core_PCS_0:ALIGNED" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:Y" "Core_PCS_0:RESET_N" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"XCVR_IF_0:LANE0_RX_CLK_R" "LANE0_RX_CLK_R" "ClockAligner_0:RX_CLK" "Core_PCS_0:EPCS_RxCLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"XCVR_IF_0:LANE0_RX_VAL" "LANE0_RX_VAL" "ClockAligner_0:RX_VAL" "Core_PCS_0:EPCS_RxRSTn" "Core_PCS_0:EPCS_RxVAL" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"INV_20bit_0:portOut" "Core_PCS_0:EPCS_RxDATA" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"INV_20bit_0:portIn" "XCVR_IF_0:LANE0_RX_DATA" "ClockAligner_0:RX_DATA" }
