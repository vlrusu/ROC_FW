...
sd_instantiate_component -sd_name ${sd_name} -component_name {CORERESET_SYNC_RXCLK} -instance_name {CORERESET_SYNC_RXCLK_0}
...
sd_instantiate_component -sd_name ${sd_name} -component_name {CORERESET_SYNC_TXCLK} -instance_name {CORERESET_SYNC_TXCLK_0}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"MX2_0:Y" "CORERESET_SYNC_RXCLK_0:CLK" "mux_rxout_0:RX_CLK" "LANE0_RX_CLK_R" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ReplyPktDecoder_0:TX_CLK" "MX2_1:Y" "LANE0_TX_CLK_R" "CORERESET_SYNC_TXCLK_0:CLK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"MX2_0:S" "MX2_5:S" "MX2_1:S" "MX2_2:S" "MX2_3:S" "MX2_4:S" "MX2_6:S" "mux_rxout_0:SIM_EN" "SIM_EN" }
