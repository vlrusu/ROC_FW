# Exporting core ROC_CCC to TCL
# Exporting Create design command for core ROC_CCC
create_and_configure_core -core_vlnv {Actel:SgCore:PF_CCC:2.2.100} -component_name {ROC_CCC} -params {\
...
# Exporting core ROC_CCC to TCL done
