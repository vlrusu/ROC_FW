# Exporting core Init_Monitor to TCL
# Exporting Create design command for core Init_Monitor
create_and_configure_core -core_vlnv {Actel:SgCore:PF_INIT_MONITOR:2.0.105} -component_name {Init_Monitor} -params {\
...
# Exporting core Init_Monitor to TCL done
