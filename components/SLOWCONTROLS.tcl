...
# Add RS485Registers_0 instance
sd_instantiate_hdl_core -sd_name ${sd_name} -hdl_core_name {RS485Registers} -instance_name {RS485Registers_0}
# Exporting Parameters of instance RS485Registers_0
sd_configure_core_instance -sd_name ${sd_name} -instance_name {RS485Registers_0} -params {\
"APB_ADDRESS_WIDTH:32" \
"APB_DATA_WIDTH:32" }\
-validate_rules 0
sd_save_core_instance_config -sd_name ${sd_name} -instance_name {RS485Registers_0}
sd_update_instance -sd_name ${sd_name} -instance_name {RS485Registers_0}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"APB3_0:APBmslave14" "RS485Registers_0:BIF_1" }
