...
sd_connect_pins -sd_name ${sd_name} -pin_names {"EW_FIFO_controller_0:ew_err_to_store" "ew_size_store_and_fetch_controller_0:store_sync_error" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"EW_FIFO_controller_0:ew_we_store" "ew_size_store_and_fetch_controller_0:store_event_we" "ewtag_cntrl_0:ew_we_store" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"EW_FIFO_controller_0:tag_addr" "ew_size_store_and_fetch_controller_0:fetch_ddr_address" }
