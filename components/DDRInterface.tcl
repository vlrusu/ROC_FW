...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_simulator_0:resetn" "MEMFIFO_0:RRESET_N" "MEMFIFO_0:WRESET_N" "MEMFIFO_RE_generator_0:rst_n" "ReadoutClkReset:FABRIC_RESET_N" "cdc_fast_slow_0:resetn_i" "cdc_fast_slow_1:resetn_i" "cdc_fast_slow_2:resetn_i" "cdc_fast_slow_3:resetn_i" "cdc_fast_slow_4:resetn_i" "cdc_fast_slow_5:resetn_i" "counter32_0:rst_n" "delay_0:rst_n" "dvl_generator_0:resetn_i" "pulse_generator_1:resetn_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DigiFifoClkReset:FABRIC_RESET_N" "FIFO_converter_32to64b_0:resetn_i" "TEMPFIFO_0:RRESET_N" "TEMPFIFO_0:WRESET_N" "pattern_FIFO_filler_0:resetn" }
