# Exporting core RXCCC to TCL
# Exporting Create design command for core RXCCC
create_and_configure_core -core_vlnv {Actel:SgCore:PF_CCC:2.2.100} -component_name {RXCCC} -params {\
...
# Exporting core RXCCC to TCL done
