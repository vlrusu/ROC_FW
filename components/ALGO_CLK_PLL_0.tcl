# Exporting core ALGO_CLK_PLL_0 to TCL
# Exporting Create design command for core ALGO_CLK_PLL_0
create_and_configure_core -core_vlnv {Actel:SgCore:PF_CCC:2.2.100} -component_name {ALGO_CLK_PLL_0} -params {\
...
# Exporting core ALGO_CLK_PLL_0 to TCL done
