...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RxPacketFIFO_1:RESET" "DCSClkReset:FABRIC_RESET_N" "DCSProcessor_0:reset_n" "DRACRegisters_0:RESET_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RXClkReset:FABRIC_RESET_N" "RxPacketFIFO_0:RESET" "RxPacketReader_0:reset_n" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RxPacketFIFO_2:RESET" "RxPacketFIFO_3:RESET" "DREQProcessor_0:reset_n" "DReqClkReset:FABRIC_RESET_N" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"TX_RESETN" "TxPacketWriter_0:reset_n" "TXClkReset:FABRIC_RESET_N" "XCVR_Block_0:TX_RESETN" }
