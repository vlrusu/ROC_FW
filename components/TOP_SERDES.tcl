...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ErrorCounter_0:clk" "LANE0_RX_CLK_R" "PBRS_checker_0:CLK" "RXClkReset:CLK" "RxMkarkerFIFO_0:WCLOCK" "RxPacketFIFO_0:WCLOCK" "RxPacketFIFO_2:WCLOCK" "RxPacketReader_0:clk" "XCVR_Block_0:LANE0_RX_CLK_R" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE0_TX_CLK_R" "MARKERProcessor_0:clk" "PRBS_generator_0:CLK" "RxMkarkerFIFO_0:RCLOCK" "RxPacketFIFO_1:RCLOCK" "RxPacketFIFO_3:RCLOCK" "TXClkReset:CLK" "TxPacketWriter_0:clk" "XCVR_Block_0:LANE0_TX_CLK_R" }
